...
SELECT '930308-2111111' "주민번호", FN_GENDER('930308-2111111') "성별확인"
FROM DUAL;
--==>> 930308-2111111	여자
...
-- 위의 업무를 프로시저(INSERT 프로시저, 입력프로시저)를 생성하게 되면
...
, ENG       NUMBER(3)
, MAT       NUMBER(3)
, CONSTRAINT SUNGJUCK_HAKBUN_PK PRIMARY KEY(HAKBUN)
);
...
--   '기존 컬럼에서 얻어낼 수 있는 값은 컬럼으로 추가하지않는다.' 원칙에 위배된다.
...
--==>> PL/SQL 프로시저가 성공적으로 완료되었습니다.
EXEC PRC_SUNGJUK_INSERT2(2, '조은선', 90, 80, 70);
--==>> PL/SQL 프로시저가 성공적으로 완료되었습니다.
SELECT *
FROM TBL_SUNGJUK;
--==>>
...
2	조은선	90	80	70	240	80	B
*/

EXEC PRC_SUNGJUK_UPDATE(1, 50, 50, 50);
--==>> PL/SQL 프로시저가 성공적으로 완료되었습니다.
EXEC PRC_SUNGJUK_UPDATE2(2, 50, 50, 50);
--==>> PL/SQL 프로시저가 성공적으로 완료되었습니다.
SELECT *
FROM TBL_SUNGJUK;
/*
1	조은선	50	50	50	150	50	F
2	조은선	50	50	50	150	50	F
*/
