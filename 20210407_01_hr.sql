...
2	소서현	계속 실습중입니다.	                        2021-04-07 09:29:26	0	0
3	이희주	힘껏 실습중입니다.	                        2021-04-07 09:30:38	0	0
...
"											NO	NO		0		NO	YES	NONE
TBL_BOARD	COUNTS	NUMBER			22			Y	6	15	"0 --조회수
...
ALTER TABLE 테이블명
MODIFY 컬렴명 [자료형] DEFAULT 기본값;

--○ 생성된 DEFAULT 표현식 제거(삭제)
ALTER TABLE 테이블명
MODIFY 컬렴명 [자료형] DEFAULT NULL;
