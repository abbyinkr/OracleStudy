...
--<과제>
--○ TBL_INSA 테이블의 급여 계산 적용 함수를 정의한다.
...
-- 확인
SELECT NAME "이름", FN_PAY(BASICPAY, SUDANG) "기본급*12 +수당"
FROM TBL_INSA;
--==>>
/*
홍길동	31520000
...
END;
--==>> Procedure PRC_SUNGJUK_UPDATE2이(가) 컴파일되었습니다.
